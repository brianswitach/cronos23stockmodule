...
import InventarioGeneral from './components/inventariogeneral'; // Importa el nuevo componente
    ...
    return (
        <Router>
            <div style={{ padding: 20 }}>
                ...
                <Button variant="contained" color="primary" component={Link} to="/productid" sx={{ margin: 1 }}>Carga de IDs</Button>
                <Button variant="contained" color="primary" component={Link} to="/inventario-general" sx={{ margin: 1 }}>Inventario general</Button> {/* Botón nuevo para Inventario General */}
                ...
                <Routes>
                    ...
                    <Route path="/inventario-general" element={<InventarioGeneral />} /> {/* Ruta nueva para Inventario General */}
                </Routes>
            </div>
        </Router>
    );
