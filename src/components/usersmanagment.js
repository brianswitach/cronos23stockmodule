    ...
    <Grid container spacing={2}>
      <Grid item xs={12}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
          <Button variant="outlined" color="secondary" onClick={toggleForm} sx={{ mr: 2 }}>
            {showForm ? 'Cancelar' : 'Agregar Producto'}
          </Button>
          <Button variant="outlined" color="primary" component={Link} to="/gestion-productos">
            Ver Productos
          </Button>
        </Box>
        {showForm && (
          <Box mt={2} width="100%">
            ...
            <Button variant="contained" color="primary" onClick={handleSaveClient} sx={{ mt: 2 }}>Guardar Producto</Button>
          </Box>
        )}
      </Grid>
    </Grid>
